...
public class ItemDetailFragment extends Fragment {
    ...
    private static DeleteItemListener mDeleteItemListener;
    /**
            ...
            rootView.findViewById(R.id.delete).setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                   if (getActivity() instanceof  ItemListActivity) {
                       ((ItemListActivity)getActivity()).deleteItem(mItem);
                   } else if (getActivity() instanceof  ItemDetailActivity) {
                       DummyContent.ITEMS.remove(mItem);
